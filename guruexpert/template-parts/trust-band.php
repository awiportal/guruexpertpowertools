...
$gx_items = array(
	array(
		...
		'desc'  => __( 'Dispatched from our Nairobi shop in 1-5 days', 'toptech-machinery' ),
	),
	array(
		...
		'desc'  => __( 'Sourced from authorised distributors', 'toptech-machinery' ),
	),
	array(
		...
		'title' => __( 'Pay your way', 'toptech-machinery' ),
		'desc'  => __( 'M-PESA, cards or cash on delivery', 'toptech-machinery' ),
	),
	array(
		...
		'title' => __( 'Expert help on hand', 'toptech-machinery' ),
		'desc'  => __( 'Talk to us on +254 708 777192', 'toptech-machinery' ),
	),
);
?>
