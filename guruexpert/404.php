...
<main id="primary" class="site-main">
	<div class="rk-404">
		...
		<h1 class="rk-404__title"><?php esc_html_e( 'Page not found', 'guruexpertpowertools' ); ?></h1>
		<p class="rk-404__text"><?php esc_html_e( 'The page you are looking for may have moved or no longer exists. Try a search, or jump straight to a product category below.', 'guruexpertpowertools' ); ?></p>
		...
		<?php if ( ! is_wp_error( $rk_cats ) && ! empty( $rk_cats ) ) : ?>
			<div class="rk-404__cats">
				<h3><?php esc_html_e( 'Popular categories', 'guruexpertpowertools' ); ?></h3>
