...
function rk_whatsapp_number(): string {
	$raw = (string) get_theme_mod( 'guruexpertpowertools_whatsapp', '254708777192' );
...
function rk_whatsapp_url( $product ): string {
	...
	$text = sprintf(
		...
		__( 'Hello, I would like to inquire about or order this item: %1$s - %2$s', 'guruexpertpowertools' ),
		$name,
		$url
	);
